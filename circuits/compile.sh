...
# Load cargo environment for circom
. "$HOME/.cargo/env"
...
npx snarkjs r1cs info build/ageVerification.r1cs
npx snarkjs r1cs info build/credentialOwnership.r1cs
npx snarkjs r1cs info build/membershipVerification.r1cs
